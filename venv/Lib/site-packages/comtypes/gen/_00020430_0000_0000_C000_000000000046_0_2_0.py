...
IFontDisp = Font
__all__ = [ 'OLE_TRISTATE', 'Font', 'LoadPictureConstants',
           'OLE_OPTEXCLUSIVE', 'FontEvents', 'IFontEventsDisp',
           'Color', 'Gray', 'OLE_YSIZE_HIMETRIC', 'FONTNAME',
           'OLE_YSIZE_PIXELS', 'FONTUNDERSCORE', 'FONTITALIC',
           'OLE_COLOR', 'StdFont', 'Checked', 'FONTBOLD',
           'OLE_XSIZE_PIXELS', 'StdPicture', 'IPictureDisp',
           'Default', 'IFont', 'Monochrome', 'IPicture', 'FONTSIZE',
           'OLE_XSIZE_CONTAINER', 'VgaColor', 'OLE_CANCELBOOL',
           'Unchecked', 'Picture', 'OLE_ENABLEDEFAULTBOOL',
           'OLE_XPOS_CONTAINER', 'OLE_YSIZE_CONTAINER',
           'OLE_XPOS_HIMETRIC', 'OLE_YPOS_CONTAINER',
           'FONTSTRIKETHROUGH', 'OLE_HANDLE', 'OLE_YPOS_HIMETRIC',
